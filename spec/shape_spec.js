describe("Shape", function() {
  ...
  describe("Rectangle", function() {
    ...
    describe("when default rectangle is created", function() {
      beforeEach(function() {
        rectangle = new brickdest.shape.Rectangle();
      });
    ...
    describe("given a rectangle", function() {
      ...
      beforeEach(function() {
        wideRectangle = new brickdest.shape.Rectangle();
        wideRectangle.width = 4.6;
        wideRectangle.height = 2.4;
        tallRectangle = new brickdest.shape.Rectangle();
        tallRectangle.width = 2.4;
        tallRectangle.height = 4.6;
      });

      it("should implement the IShape interface", function() {
        expect(brickdest.shape.IShape.isImplementedBy(wideRectangle)).toBeTruthy();
      });
