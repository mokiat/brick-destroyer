describe("SpawnOnDestroyComponent", function() {
  ...
  beforeEach(function() {
    ...
    var resourceCollection = new resources.Collection();
    var entityFactory = new game.EntityFactory(manager, resourceCollection);
    system = new game.SpawnOnDestroySystem(manager, entityFactory);
    ...
    entity.addComponent("spawnOnDestroy", new game.SpawnOnDestroyComponent({
      "definition" : {
        "motion" : {
          "speed" : {
            "x" : 13.4,
