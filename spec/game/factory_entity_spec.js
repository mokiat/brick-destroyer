describe("EntityFactory", function() {
  ...
  beforeEach(function() {
    ...
    factory = new game.EntityFactory(manager, resourceCollection);
  });
  ...
  describe("when definition is empty", function() {
    ...
    it("an empty entity should have been created", function() {
      ...
      expect(entity instanceof ecs.Entity).toBeTruthy();
    });
  });
  ...
  describe("when definition has collision with circle shape", function() {
    ...
    it("an entity with collision component with circle shape should have been created", function() {
      ...
      expect(component.shape instanceof shapes.Circle).toBeTruthy();
  ...
  describe("when definition has collision with rectangle shape", function() {
    ...
    it("an entity with collision component with rectangle shape should have been created", function() {
      ...
      expect(component.friction).toBeCloseTo(0.4, decimalPoints);
      expect(component.mass).toBeCloseTo(0.5, decimalPoints);
      expect(component.shape instanceof shapes.Rectangle).toBeTruthy();
      var shape = component.shape;
  ...
  describe("when definition has bounceToggleable", function() {
    var sliderOnImage;
    var sliderOffImage;

    beforeEach(function() {
      sliderOnImage = new resources.Resource();
      resourceCollection.register("slider_on", sliderOnImage);

      sliderOffImage = new resources.Resource();
    ...
    it("an entity with bounceToggleable component should have been created", function() {
      expect(entity.hasComponent("bounceToggleable")).toBeTruthy();
      var component = entity.getComponent("bounceToggleable");
