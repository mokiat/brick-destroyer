describe("Entity-Component-System Components", function() {
  ...
  describe("LocationComponent", function() {
    describe("when a default one is created", function() {
      beforeEach(function() {
        component = new game.LocationComponent();
      });
    ...
    describe("when a config-based one is created", function() {
      beforeEach(function() {
        component = new game.LocationComponent({
          location: new math.Vector(1.2, 3.4)
        });
      });
  ...
  describe("MotionComponent", function() {
    describe("when a default one is created", function() {
      beforeEach(function() {
        component = new game.MotionComponent();
      });
  ...
  describe("CollisionComponent", function() {
    describe("when a default one is created", function() {
      beforeEach(function() {
        component = new game.CollisionComponent();
      });
  ...
  describe("SpriteComponent", function() {
    describe("when a default one is created", function() {
      beforeEach(function() {
        component = new game.SpriteComponent();
      });
  ...
  describe("MouseBoundComponent", function() {
    describe("when a default one is created", function() {
      beforeEach(function() {
        component = new game.MouseBoundComponent();
      });
  ...
  describe("LocationBoundComponent", function() {
    describe("when a default one is created", function() {
      beforeEach(function() {
        component = new game.LocationBoundComponent();
      });
  ...
  describe("SpawnOnDestroyComponent", function() {
    describe("when a default one is created", function() {
      beforeEach(function() {
        component = new game.SpawnOnDestroyComponent();
      });
  ...
  describe("BounceToggleableComponent", function() {
    describe("when a default one is created", function() {
      beforeEach(function() {
        component = new game.BounceToggleableComponent();
      });
    ...
    describe("when a config-based one is created", function() {
      ...
      beforeEach(function() {
        ...
        component = new game.BounceToggleableComponent({
          ...
          deflection: new math.Vector(7.6, 5.3)
        });
      });
  ...
  describe("TimerDestroyComponent", function() {
    describe("when a default one is created", function() {
      beforeEach(function() {
        component = new game.TimerDestroyComponent();
      });
  ...
  describe("ExplodeOnDestroyComponent", function() {
    describe("when a default one is created", function() {
      beforeEach(function() {
        component = new game.ExplodeOnDestroyComponent();
      });
