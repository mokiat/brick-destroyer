describe("CollisionEvaluator", function() {
  ...
  beforeEach(function() {
    evaluator = new game.CollisionEvaluator();
    manager = new ecs.EntityManager();

    staticRect = manager.createEntity();
    staticRect.addComponent("location", new game.LocationComponent({
      location: new math.Vector(10.0, 10.0)
    }));
    staticRect.addComponent("collision", new game.CollisionComponent({
    ...
    candidateRect.addComponent("location", new game.LocationComponent());
    candidateRect.addComponent("collision", new game.CollisionComponent({
      shape: new shapes.Rectangle({
        width: 2.0,
        height: 2.0
      })
    ...
    staticCircle.addComponent("location", new game.LocationComponent({
      location: new math.Vector(10.0, 10.0)
    }));
    staticCircle.addComponent("collision", new game.CollisionComponent({
    ...
    candidateCircle.addComponent("location", new game.LocationComponent());
    candidateCircle.addComponent("collision", new game.CollisionComponent({
      shape: new shapes.Circle({
        radius: 1.0
      })
    }));
