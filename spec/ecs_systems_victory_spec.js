describe("VictorySystem", function() {
  ...
  beforeEach(function() {
    ...
    system = new brickdest.ecs.VictorySystem(manager);
    manager.addSystem(system);

    firstEntity = manager.createEntity();
    firstEntity.addComponent("shouldDestroy", new brickdest.ecs.ShouldDestroyComponent());

    secondEntity = manager.createEntity();
    secondEntity.addComponent("shouldDestroy", new brickdest.ecs.ShouldDestroyComponent());
