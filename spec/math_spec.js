describe("Vector", function() {
  ...
  beforeEach(function() {
    vector = new brickdest.math.Vector(2.0, 3.0);
  })
  ...
  it("can be created as copy", function() {
    var copy = new brickdest.math.Vector(vector);
    assertVector(copy, 2.0, 3.0);
  });

  it("can be created without values", function() {
    var vector = new brickdest.math.Vector();
  ...
  it("is possible to increment vector with vector", function() {
    var increment = new brickdest.math.Vector(3.5, 6.7);
  ...
  it("is possible to decrement vector with vector", function() {
    var decrement = new brickdest.math.Vector(2.3, 1.4);
